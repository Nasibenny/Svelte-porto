    ...
    <div class="flex flex-col mt-5 ">
        ...
        <div class="flex flex-col mt-2 text-center  max-w-[25.5cm] mx-auto leading-relaxed"   >
            ...
            <p class="f-h4 text-md text-justify" >
                ...
                As a Frontend Developer  makes me good at designing the UI & UX in the website also
                i’m good at designing with several designing application
                such as Canva, Figma.
                I’m dicipline person, hardwork, good at
                teamwork and diligent person. thats makes me fit in the job
            </p>
